...
//      runStatementOnDriver("create table T like " + Table.ACIDTBL);
  ...
  public void testImportPartitioned() throws Exception {
    ...
    String[][] expected = new String[][] {
        {"{\"writeid\":2,\"bucketid\":536870912,\"rowid\":0}\t0\t0",
            "t/p=10/delta_0000002_0000002_0000/bucket_00000"},
        {"{\"writeid\":3,\"bucketid\":536870912,\"rowid\":0}\t3\t4",
            "t/p=11/delta_0000003_0000003_0000/000000_0"},
        {"{\"writeid\":4,\"bucketid\":536870912,\"rowid\":0}\t5\t6",
            "t/p=12/delta_0000004_0000004_0000/000000_0"}};
    checkResult(expected, testQuery, isVectorized, "import existing table");
  }
