            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.metadata = new HashMap<Long,MetadataPpdResult>(2*_map828.size);
                long _key829;
                MetadataPpdResult _val830;
                for (int _i831 = 0; _i831 < _map828.size; ++_i831)
                {
                  _key829 = iprot.readI64();
                  _val830 = new MetadataPpdResult();
                  _val830.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetFileMetadataByExprResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.metadata != null) {
        oprot.writeFieldBegin(METADATA_FIELD_DESC);
        {
          ...
          for (Map.Entry<Long, MetadataPpdResult> _iter832 : struct.metadata.entrySet())
          {
            oprot.writeI64(_iter832.getKey());
            _iter832.getValue().write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class GetFileMetadataByExprResultTupleScheme extends TupleScheme<GetFileMetadataByExprResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, GetFileMetadataByExprResult struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<Long, MetadataPpdResult> _iter833 : struct.metadata.entrySet())
        {
          oprot.writeI64(_iter833.getKey());
          _iter833.getValue().write(oprot);
        }
      }
      oprot.writeBool(struct.isSupported);
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetFileMetadataByExprResult struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map834 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.metadata = new HashMap<Long,MetadataPpdResult>(2*_map834.size);
        long _key835;
        MetadataPpdResult _val836;
        for (int _i837 = 0; _i837 < _map834.size; ++_i837)
        {
          _key835 = iprot.readI64();
          _val836 = new MetadataPpdResult();
          _val836.read(iprot);
          struct.metadata.put(_key835, _val836);
        }
      }
      struct.setMetadataIsSet(true);
      struct.isSupported = iprot.readBool();
