...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class CreateTableRequest implements org.apache.thrift.TBase<CreateTableRequest, CreateTableRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateTableRequest> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 8: // CHECK_CONSTRAINTS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1055 = iprot.readListBegin();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processorCapabilities = new ArrayList<String>(_list1058.size);
                String _elem1059;
      ...
      if (struct.primaryKeys != null) {
        if (struct.isSetPrimaryKeys()) {
          oprot.writeFieldBegin(PRIMARY_KEYS_FIELD_DESC);
          {
            ...
            for (SQLPrimaryKey _iter1061 : struct.primaryKeys)
            {
      ...
      if (struct.foreignKeys != null) {
        if (struct.isSetForeignKeys()) {
          oprot.writeFieldBegin(FOREIGN_KEYS_FIELD_DESC);
          {
            ...
            for (SQLForeignKey _iter1062 : struct.foreignKeys)
            {
      ...
      if (struct.uniqueConstraints != null) {
        if (struct.isSetUniqueConstraints()) {
          oprot.writeFieldBegin(UNIQUE_CONSTRAINTS_FIELD_DESC);
          {
            ...
            for (SQLUniqueConstraint _iter1063 : struct.uniqueConstraints)
            {
      ...
      if (struct.notNullConstraints != null) {
        if (struct.isSetNotNullConstraints()) {
          oprot.writeFieldBegin(NOT_NULL_CONSTRAINTS_FIELD_DESC);
          {
            ...
            for (SQLNotNullConstraint _iter1064 : struct.notNullConstraints)
            {
      ...
      if (struct.defaultConstraints != null) {
        if (struct.isSetDefaultConstraints()) {
          oprot.writeFieldBegin(DEFAULT_CONSTRAINTS_FIELD_DESC);
          {
            ...
            for (SQLDefaultConstraint _iter1065 : struct.defaultConstraints)
            {
      ...
      if (struct.checkConstraints != null) {
        if (struct.isSetCheckConstraints()) {
          oprot.writeFieldBegin(CHECK_CONSTRAINTS_FIELD_DESC);
          {
            ...
            for (SQLCheckConstraint _iter1066 : struct.checkConstraints)
            {
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (String _iter1067 : struct.processorCapabilities)
            {
  ...
  private static class CreateTableRequestTupleScheme extends TupleScheme<CreateTableRequest> {
      ...
      if (struct.isSetPrimaryKeys()) {
        {
          ...
          for (SQLPrimaryKey _iter1068 : struct.primaryKeys)
          {
      ...
      if (struct.isSetForeignKeys()) {
        {
          ...
          for (SQLForeignKey _iter1069 : struct.foreignKeys)
          {
      ...
      if (struct.isSetUniqueConstraints()) {
        {
          ...
          for (SQLUniqueConstraint _iter1070 : struct.uniqueConstraints)
          {
      ...
      if (struct.isSetNotNullConstraints()) {
        {
          ...
          for (SQLNotNullConstraint _iter1071 : struct.notNullConstraints)
          {
      ...
      if (struct.isSetDefaultConstraints()) {
        {
          ...
          for (SQLDefaultConstraint _iter1072 : struct.defaultConstraints)
          {
      ...
      if (struct.isSetCheckConstraints()) {
        {
          ...
          for (SQLCheckConstraint _iter1073 : struct.checkConstraints)
          {
      ...
      if (struct.isSetProcessorCapabilities()) {
        {
          ...
          for (String _iter1074 : struct.processorCapabilities)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CreateTableRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list1075 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.primaryKeys = new ArrayList<SQLPrimaryKey>(_list1075.size);
          SQLPrimaryKey _elem1076;
          for (int _i1077 = 0; _i1077 < _list1075.size; ++_i1077)
          {
            _elem1076 = new SQLPrimaryKey();
            _elem1076.read(iprot);
            struct.primaryKeys.add(_elem1076);
          }
        }
        struct.setPrimaryKeysIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list1078 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.foreignKeys = new ArrayList<SQLForeignKey>(_list1078.size);
          SQLForeignKey _elem1079;
          for (int _i1080 = 0; _i1080 < _list1078.size; ++_i1080)
          {
            _elem1079 = new SQLForeignKey();
            _elem1079.read(iprot);
            struct.foreignKeys.add(_elem1079);
          }
        }
        struct.setForeignKeysIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.uniqueConstraints = new ArrayList<SQLUniqueConstraint>(_list1081.size);
          SQLUniqueConstraint _elem1082;
          for (int _i1083 = 0; _i1083 < _list1081.size; ++_i1083)
          {
            _elem1082 = new SQLUniqueConstraint();
            _elem1082.read(iprot);
            struct.uniqueConstraints.add(_elem1082);
          }
        }
        struct.setUniqueConstraintsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.notNullConstraints = new ArrayList<SQLNotNullConstraint>(_list1084.size);
          SQLNotNullConstraint _elem1085;
          for (int _i1086 = 0; _i1086 < _list1084.size; ++_i1086)
          {
            _elem1085 = new SQLNotNullConstraint();
            _elem1085.read(iprot);
            struct.notNullConstraints.add(_elem1085);
          }
        }
        struct.setNotNullConstraintsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.defaultConstraints = new ArrayList<SQLDefaultConstraint>(_list1087.size);
          SQLDefaultConstraint _elem1088;
          for (int _i1089 = 0; _i1089 < _list1087.size; ++_i1089)
          {
            _elem1088 = new SQLDefaultConstraint();
            _elem1088.read(iprot);
            struct.defaultConstraints.add(_elem1088);
          }
        }
        struct.setDefaultConstraintsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.checkConstraints = new ArrayList<SQLCheckConstraint>(_list1090.size);
          SQLCheckConstraint _elem1091;
          for (int _i1092 = 0; _i1092 < _list1090.size; ++_i1092)
          {
            _elem1091 = new SQLCheckConstraint();
            _elem1091.read(iprot);
            struct.checkConstraints.add(_elem1091);
          }
        }
        struct.setCheckConstraintsIsSet(true);
      }
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1093 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.processorCapabilities = new ArrayList<String>(_list1093.size);
          String _elem1094;
          for (int _i1095 = 0; _i1095 < _list1093.size; ++_i1095)
          {
            _elem1094 = iprot.readString();
            struct.processorCapabilities.add(_elem1094);
          }
        }
        struct.setProcessorCapabilitiesIsSet(true);
      }
