            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.functions = new ArrayList<Function>(_list888.size);
                Function _elem889;
                for (int _i890 = 0; _i890 < _list888.size; ++_i890)
                {
                  _elem889 = new Function();
                  _elem889.read(iprot);
                  struct.functions.add(_elem889);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.functions = new ArrayList<Function>(_list893.size);
          Function _elem894;
          for (int _i895 = 0; _i895 < _list893.size; ++_i895)
          {
            _elem894 = new Function();
            _elem894.read(iprot);
            struct.functions.add(_elem894);
          }
        }
        struct.setFunctionsIsSet(true);
      }
