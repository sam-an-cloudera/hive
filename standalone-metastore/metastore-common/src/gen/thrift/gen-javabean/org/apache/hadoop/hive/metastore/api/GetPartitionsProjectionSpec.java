            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fieldList = new ArrayList<String>(_list1048.size);
                String _elem1049;
                for (int _i1050 = 0; _i1050 < _list1048.size; ++_i1050)
                {
                  _elem1049 = iprot.readString();
                  struct.fieldList.add(_elem1049);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPartitionsProjectionSpec struct) throws org.apache.thrift.TException {
      ...
      if (struct.fieldList != null) {
        oprot.writeFieldBegin(FIELD_LIST_FIELD_DESC);
        {
          ...
          for (String _iter1051 : struct.fieldList)
          {
      ...
      if (struct.isSetFieldList()) {
        {
          ...
          for (String _iter1052 : struct.fieldList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fieldList = new ArrayList<String>(_list1053.size);
          String _elem1054;
          for (int _i1055 = 0; _i1055 < _list1053.size; ++_i1055)
          {
            _elem1054 = iprot.readString();
            struct.fieldList.add(_elem1054);
          }
        }
        struct.setFieldListIsSet(true);
      }
