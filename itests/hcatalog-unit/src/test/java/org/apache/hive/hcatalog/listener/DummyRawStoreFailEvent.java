...
public class DummyRawStoreFailEvent implements RawStore, Configurable {
  ...
  @Override
  public List<Partition> getPartitions(String catName, String dbName, String tableName, int max, String writeIdList)
      throws MetaException, NoSuchObjectException {
  ...
  @Override
  public List<String> listPartitionNames(String catName, String dbName, String tblName, short maxParts, String writeIdList)
      throws MetaException {
  ...
  public Partition getPartitionWithAuth(String catName, String dbName, String tblName,
                                        List<String> partVals, String userName,
                                        List<String> groupNames, String writeIdList)
      throws MetaException, NoSuchObjectException, InvalidObjectException {
  ...
  public List<String> listPartitionNamesPs(String catName, String dbName, String tblName,
                                           List<String> partVals, short maxParts, String writeIdList)
      throws MetaException, NoSuchObjectException {
  ...
  public boolean doesPartitionExist(String catName, String dbName, String tableName,
                                    List<FieldSchema> partKeys, List<String> partVals, String writeIdList)
      throws MetaException, NoSuchObjectException {
